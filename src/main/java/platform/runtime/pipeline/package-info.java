 ...
 * <ul>
 *   <li>{@link platform.runtime.pipeline.ExecutionPipeline} - Pipeline contract</li>
 *   <li>{@link platform.runtime.pipeline.ExecutionStage} - Stage contract</li>
 *   <li>{@link platform.runtime.pipeline.ExecutionChain} - Chain contract</li>
 *   <li>{@link platform.runtime.pipeline.DefaultExecutionPipeline} - Default pipeline implementation</li>
 *   <li>{@link platform.runtime.pipeline.DefaultExecutionChain} - Default chain implementation</li>
 *   <li>{@link platform.runtime.pipeline.PipelineContext} - Immutable context</li>
 *   <li>{@link platform.runtime.pipeline.PipelineResult} - Immutable result</li>
 *   <li>{@link platform.runtime.pipeline.PipelineExecutionState} - Runtime-owned execution state</li>
 *   <li>{@link platform.runtime.pipeline.PipelineStageDescriptor} - Stage metadata</li>
 * </ul>
 *
