 ...
 * <ul>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentService} — primary façade</li>
 *   <li>{@link platform.kernels.multiagent.api.AgentRegistryService} — agent registration</li>
 *   <li>{@link platform.kernels.multiagent.api.AgentDiscoveryService} — agent discovery</li>
 *   <li>{@link platform.kernels.multiagent.api.CapabilityRegistryService} — capability management</li>
 *   <li>{@link platform.kernels.multiagent.api.AgentLifecycleService} — lifecycle management</li>
 *   <li>{@link platform.kernels.multiagent.api.AgentCommunicationService} — communication</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes} — bootstrap types</li>
 * </ul>
 *
 * <p><b>Bootstrap Records:</b></p>
 * <ul>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentRequest}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentResponse}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentDescriptor}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentCapability}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentRegistration}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentStatus}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.AgentCommunication}</li>
 *   <li>{@link platform.kernels.multiagent.api.MultiAgentTypes.MultiAgentMetrics}</li>
 * </ul>
 *
