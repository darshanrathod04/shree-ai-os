 ...
 * @see platform.kernels.memory.model.MemoryId
 * @see platform.kernels.memory.model.Memory
 * @see platform.kernels.memory.model.MemoryContent
 * @see platform.kernels.memory.model.MemoryMetadata
 * @see platform.kernels.memory.model.MemoryStatistics
 * @see platform.kernels.memory.model.CreateMemoryRequest
 * @see platform.kernels.memory.model.UpdateMemoryRequest
 */
