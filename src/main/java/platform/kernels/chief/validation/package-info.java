 ...
 * <p><b>Validators:</b></p>
 * <ul>
 *   <li>{@link platform.kernels.chief.validation.ChiefValidator} — primary validation entry point</li>
 *   <li>{@link platform.kernels.chief.validation.DecisionValidator} — validates DecisionContext and DecisionResult</li>
 *   <li>{@link platform.kernels.chief.validation.GoalValidator} — validates GoalDescriptor</li>
 *   <li>{@link platform.kernels.chief.validation.DelegationValidator} — validates DelegationResult</li>
 *   <li>{@link platform.kernels.chief.validation.CoordinationValidator} — validates CoordinationState</li>
 *   <li>{@link platform.kernels.chief.validation.ChiefCriteriaValidator} — validates ChiefRequest, ChiefResponse, ChiefMetrics, ChiefSnapshot</li>
 * </ul>
 *
