 ...
 * <ul>
 *   <li>{@link platform.kernels.chief.verification.ChiefVerificationSuite} — verification facade</li>
 *   <li>{@link platform.kernels.chief.verification.ChiefArchitectureVerifier} — architecture verifier</li>
 *   <li>{@link platform.kernels.chief.verification.ChiefContractVerifier} — contract verifier</li>
 *   <li>{@link platform.kernels.chief.verification.ChiefIntegrityVerifier} — integrity verifier</li>
 *   <li>{@link platform.kernels.chief.verification.ChiefVerificationResult} — immutable verification result</li>
 * </ul>
 *
