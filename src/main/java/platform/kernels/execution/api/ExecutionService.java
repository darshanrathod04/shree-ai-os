...
public interface ExecutionService {
     ...
     */
    String executeAction(platform.kernels.execution.model.ExecutionRequest executionRequest);
     ...
     * @throws IllegalArgumentException if executionRequest is {@code null}
     */
    String executeWorkflow(platform.kernels.execution.model.ExecutionRequest executionRequest);
     ...
     * @throws IllegalArgumentException if executionRequest is {@code null}
     */
    String executeTask(platform.kernels.execution.model.ExecutionRequest executionRequest);
     ...
     */
    platform.kernels.execution.model.ExecutionStatus getExecutionStatus(String executionId);
     ...
     */
    String recoverExecution(String executionId, platform.kernels.execution.model.RecoveryStrategy recoveryStrategy);
}