...
public interface WorkflowExecutionService {
     ...
     * @throws IllegalArgumentException if workflowId is {@code null} or empty
     */
    platform.kernels.execution.model.WorkflowState getWorkflowState(String workflowId);
     ...
     * @throws IllegalArgumentException if workflowId is {@code null} or empty
     */
    platform.kernels.execution.model.ExecutionResult getWorkflowResult(String workflowId);
