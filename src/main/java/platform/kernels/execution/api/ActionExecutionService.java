...
public interface ActionExecutionService {
     ...
     * @throws IllegalArgumentException if executionId is {@code null} or empty
     */
    platform.kernels.execution.model.ActionState getActionStatus(String executionId);
     ...
     * @throws IllegalArgumentException if executionId is {@code null} or empty
     */
    platform.kernels.execution.model.ExecutionResult getActionResult(String executionId);
