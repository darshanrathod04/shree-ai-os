...
import platform.kernels.execution.model.ExecutionMetrics;
import platform.kernels.execution.model.WorkflowState;
import platform.kernels.execution.model.ActionState;
import platform.kernels.execution.model.ExecutionSnapshot;
...
public final class DefaultExecutionProcessingEngine implements ExecutionProcessingEngine {
    ...
    public ExecutionProcessingResult processExecutionRecovery(String executionId, RecoveryStrategy recoveryStrategy) {
        ...
        ExecutionRequest recoveryRequest = new ExecutionRequest(
                new platform.kernels.execution.model.ExecutionId(executionId),
                "recovery-" + executionId,
                new platform.kernels.execution.model.ExecutionContext(
                        new platform.kernels.execution.model.ExecutionId(executionId),
                        "recovery-plan",
                        "recovery-objective",
                ...
                new platform.kernels.execution.model.ExecutionOptions(
                        0,
                        0,
                        0,
                        false,
