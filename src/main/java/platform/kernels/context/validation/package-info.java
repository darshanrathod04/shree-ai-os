 ...
 *
 * @see platform.kernels.context.validation.ContextValidationResult
 * @see platform.kernels.context.validation.ContextValidator
 * @see platform.kernels.context.validation.ConversationContextValidator
 * @see platform.kernels.context.validation.ExecutionContextValidator
 * @see platform.kernels.context.validation.SessionContextValidator
 * @see platform.kernels.context.validation.TaskContextValidator
 */
