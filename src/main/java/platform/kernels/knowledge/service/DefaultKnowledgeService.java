package platform.kernels.knowledge.service;

import platform.kernels.knowledge.api.KnowledgeExtractionService;
import platform.kernels.knowledge.api.KnowledgeGraphService;
import platform.kernels.knowledge.api.KnowledgeQueryService;
import platform.kernels.knowledge.api.KnowledgeService;
import platform.kernels.knowledge.engine.KnowledgeProcessingEngine;
import platform.kernels.knowledge.error.KnowledgeError;
import platform.kernels.knowledge.error.KnowledgeErrorCode;
import platform.kernels.knowledge.error.KnowledgeValidationException;
import platform.kernels.knowledge.model.CreateKnowledgeRequest;
...
import platform.kernels.knowledge.model.KnowledgeRelationshipType;
import platform.kernels.knowledge.model.UpdateKnowledgeRequest;
 ...
 *   <li>Translates failures into the {@link platform.kernels.knowledge.error.KnowledgeException} hierarchy.</li>
 ...
 * @see platform.kernels.knowledge.engine.KnowledgeProcessingEngine
...
public final class DefaultKnowledgeService implements
    ...
    private KnowledgeNode buildUpdatedNode(KnowledgeId id, UpdateKnowledgeRequest request) {
        return KnowledgeNode.of(
                id,
                platform.kernels.knowledge.model.KnowledgeType.CONCEPT,
                platform.kernels.knowledge.model.KnowledgeState.ACTIVE,
                platform.kernels.knowledge.model.KnowledgeScope.GLOBAL,
                request.getLabel(),
                request.getDescription(),
                request.getMetadata(),
                Instant.now(),
