 ...
 *   <li>Returns {@link platform.kernels.knowledge.verification.KnowledgeVerificationResult} from all operations.</li>
 ...
 *
 * @see platform.kernels.knowledge.verification.KnowledgeArchitectureVerifier
 * @see platform.kernels.knowledge.verification.KnowledgeContractVerifier
 * @see platform.kernels.knowledge.verification.KnowledgeIntegrityVerifier
 * @see platform.kernels.knowledge.verification.KnowledgeVerificationSuite
 * @see platform.kernels.knowledge.verification.KnowledgeVerificationResult
 */
