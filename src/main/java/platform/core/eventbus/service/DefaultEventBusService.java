...
import platform.core.eventbus.api.EventBus;
    ...
    public void publish(Event event) {
        ...
        if (!validationResult.isValid()) {
            throw new InvalidEventException(
                    new platform.core.eventbus.error.EventError(
                            platform.core.eventbus.error.EventErrorCode.EVENT_INVALID,
        ...
        if (topicSubscribers == null || topicSubscribers.isEmpty()) {
            throw new NoSubscribersException(
                    new platform.core.eventbus.error.EventError(
                            platform.core.eventbus.error.EventErrorCode.EVENT_NO_SUBSCRIBERS,
