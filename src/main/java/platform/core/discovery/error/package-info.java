 ...
 * </ul>
 *
 * @see platform.core.discovery.error.DiscoveryErrorCode
 * @see platform.core.discovery.error.DiscoveryError
 * @see platform.core.discovery.error.DiscoveryException
 */
