 ...
 * </ul>
 *
 * @see platform.core.lifecycle.error.LifecycleException
 * @see platform.core.lifecycle.error.LifecycleError
 * @see platform.core.lifecycle.error.LifecycleErrorCode
 */
