package platform.core.plugin.validator;
 ...
 * @see platform.core.plugin.model.PluginId
 * @see platform.core.plugin.model.Plugin
 * @see platform.core.plugin.model.PluginDescriptor
 * @see platform.core.plugin.model.PluginRequest
