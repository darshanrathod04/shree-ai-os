 ...
 *
 * @see platform.core.health.error.HealthErrorCode
 * @see platform.core.health.error.HealthError
 * @see platform.core.health.error.HealthException
 * @see platform.core.health.error.HealthComponentNotFoundException
 * @see platform.core.health.error.HealthCheckFailedException
 * @see platform.core.health.error.InvalidHealthComponentException
 */
