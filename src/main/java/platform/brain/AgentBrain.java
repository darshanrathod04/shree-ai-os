...
import platform.brain.perception.IdentityPerceptionEngine;
...
import platform.debate.swarm.DebateSwarmEngine;
import platform.dto.AgentResponse;
import platform.graph.KnowledgeGraphEngine;
import platform.llm.OllamaClient;
import platform.memory.MemoryFacade;
import platform.project.ProjectIntelligenceEngine;
import platform.personality.PersonalityEngine;
import platform.router.SkillRouter;
import platform.skills.Skill;
import platform.learning.CourseState;
import platform.learning.LearningSessionEngine;
import platform.learning.TeachingEngine;
import platform.capability.CapabilityMatch;
import platform.capability.CapabilityRegistry;
import platform.resolver.CapabilityResolution;
import platform.resolver.CapabilityResolver;
import platform.cognition.uqc.ClassificationResult;
import platform.cognition.uqc.UniversalQueryClassifier;
import platform.learning.adaptive.AdaptiveLearningEngine;
import platform.learning.adaptive.StudentLearningProfile;
import platform.production.ConversationOptimizer;
import platform.production.ContextResolutionEngine;
import platform.production.FallbackEngine;
import platform.production.ResolvedContext;
import platform.production.ResponseRouter;
import platform.validation.DecisionValidator;
