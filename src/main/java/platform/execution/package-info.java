 ...
 * <ul>
 *   <li>{@link platform.execution.ExecutionRequest} - Immutable request model</li>
 *   <li>{@link platform.execution.ExecutionResult} - Immutable result model</li>
 *   <li>{@link platform.execution.ExecutionStatus} - Execution status enum</li>
 *   <li>{@link platform.execution.ExecutionType} - Execution type enum</li>
 *   <li>{@link platform.execution.ExecutionMetadata} - Immutable metadata model</li>
 *   <li>{@link platform.execution.ExecutableCapability} - Core capability interface</li>
 *   <li>{@link platform.execution.ExecutionContext} - Immutable context helper</li>
 * </ul>
 *
