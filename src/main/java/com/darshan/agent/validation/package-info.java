 ...
 * <ul>
 *   <li>{@link com.darshan.agent.validation.DecisionValidator} - Main validator class</li>
 *   <li>{@link com.darshan.agent.validation.ValidationResult} - Immutable validation result</li>
 *   <li>{@link com.darshan.agent.validation.ValidationStatus} - Validation status enum</li>
 *   <li>{@link com.darshan.agent.validation.ValidationStrategy} - Validation strategy enum</li>
 * </ul>
 *
 * <h2>Thread Safety</h2>
