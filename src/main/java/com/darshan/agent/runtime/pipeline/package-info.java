 ...
 * <ul>
 *   <li>{@link com.darshan.agent.runtime.pipeline.ExecutionPipeline} - Pipeline contract</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.ExecutionStage} - Stage contract</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.ExecutionChain} - Chain contract</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.DefaultExecutionPipeline} - Default pipeline implementation</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.DefaultExecutionChain} - Default chain implementation</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.PipelineContext} - Immutable context</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.PipelineResult} - Immutable result</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.PipelineExecutionState} - Runtime-owned execution state</li>
 *   <li>{@link com.darshan.agent.runtime.pipeline.PipelineStageDescriptor} - Stage metadata</li>
 * </ul>
 *
