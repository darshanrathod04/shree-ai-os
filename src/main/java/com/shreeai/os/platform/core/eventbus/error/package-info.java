 ...
 *
 * @see com.shreeai.os.platform.core.eventbus.error.EventErrorCode
 * @see com.shreeai.os.platform.core.eventbus.error.EventError
 * @see com.shreeai.os.platform.core.eventbus.error.EventBusException
 */
