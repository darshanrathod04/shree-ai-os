 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.core.plugin.engine.PluginTransitionResult} — Immutable
 *       result capturing the outcome of a lifecycle transition.</li>
 *   <li>{@link com.shreeai.os.platform.core.plugin.engine.PluginLifecycleEngine} — Stateless
 ...
 *
 * @see com.shreeai.os.platform.core.plugin.engine.PluginLifecycleEngine
 * @see com.shreeai.os.platform.core.plugin.engine.PluginTransitionResult
 * @see com.shreeai.os.platform.core.plugin.model.PluginState
 * @see com.shreeai.os.platform.core.plugin.model.PluginDescriptor
 */
package com.shreeai.os.platform.core.plugin.engine;