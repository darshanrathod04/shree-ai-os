 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.core.plugin.verification.PluginVerifier} — The orchestrator
 *       that runs the full verification pipeline.</li>
 *   <li>{@link com.shreeai.os.platform.core.plugin.verification.VerificationResult} — Immutable
 *       result containing a validity flag and a list of issues.</li>
 *   <li>{@link com.shreeai.os.platform.core.plugin.verification.VerificationIssue} — Immutable
 *       issue with a severity level and message.</li>
 *   <li>{@link com.shreeai.os.platform.core.plugin.verification.VerificationSeverity} — Severity
 *       levels: INFO, WARNING, ERROR.</li>
 *   <li>{@link com.shreeai.os.platform.core.plugin.verification.PluginCompatibilityChecker} —
 *       Checks Java version, platform version, and plugin API compatibility.</li>
 *   <li>{@link com.shreeai.os.platform.core.plugin.verification.PluginDependencyChecker} —
 ...
 *
 * @see com.shreeai.os.platform.core.plugin.verification.PluginVerifier
 * @see com.shreeai.os.platform.core.plugin.verification.VerificationResult
 * @see com.shreeai.os.platform.core.plugin.verification.VerificationIssue
 * @see com.shreeai.os.platform.core.plugin.verification.VerificationSeverity
 * @see com.shreeai.os.platform.core.plugin.verification.PluginCompatibilityChecker
 * @see com.shreeai.os.platform.core.plugin.verification.PluginDependencyChecker
 */
