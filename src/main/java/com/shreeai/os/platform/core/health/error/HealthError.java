 ...
 * <b>HealthError</b>
 *
 * <p>Immutable error model for the Health subsystem within Shree AI OS.</p>
 *
 * <p><b>Architectural Responsibility:</b></p>
 * <ul>
 *   <li>Encapsulates error information for health operations.</li>
 *   <li>Provides structured error data with code, message, timestamp, and details.</li>
 *   <li>Enables consistent error reporting across the Health subsystem.</li>
 * </ul>
 *
...
public final class HealthError {
    ...
    private final HealthErrorCode code;
    private final String message;
    private final Instant timestamp;
    private final Map<String, Object> details;

    /**
     * Constructs a new {@code HealthError} with the given parameters.
     *
     ...
     */
    public HealthError(HealthErrorCode code,
                       String message,
                       Instant timestamp,
                       Map<String, Object> details) {
        this.code = Objects.requireNonNull(code, "HealthErrorCode must not be null");
    ...
    public boolean equals(Object o) {
        ...
        HealthError that = (HealthError) o;
