 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.validation.DecisionValidator} - Main validator class</li>
 *   <li>{@link com.shreeai.os.platform.validation.ValidationResult} - Immutable validation result</li>
 *   <li>{@link com.shreeai.os.platform.validation.ValidationStatus} - Validation status enum</li>
 *   <li>{@link com.shreeai.os.platform.validation.ValidationStrategy} - Validation strategy enum</li>
 * </ul>
 *
 * <h2>Thread Safety</h2>
