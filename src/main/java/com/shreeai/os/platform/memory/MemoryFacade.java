package com.shreeai.os.platform.memory;
...
import com.shreeai.os.platform.memory.semantic.Concept;
...
public class MemoryFacade {
     ...
     */
    public List<Concept> getTopConcepts(int limit) {
     ...
     */
    public void saveConversationEntry(ConversationEntry entry) {
