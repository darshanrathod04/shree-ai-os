 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.ChiefErrorCode} — canonical error identifiers</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.ChiefError} — immutable error information</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.ChiefException} — canonical base exception</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.DecisionException} — decision failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.GoalManagementException} — goal management failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.TaskDelegationException} — delegation failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.KernelCoordinationException} — coordination failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.error.ChiefValidationException} — validation failures</li>
 * </ul>
 *
