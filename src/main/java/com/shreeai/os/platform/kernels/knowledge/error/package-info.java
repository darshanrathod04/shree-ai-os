 ...
 *   <li>Ensures every exception encapsulates exactly one immutable {@link com.shreeai.os.platform.kernels.knowledge.error.KnowledgeError}.</li>
 ...
 *
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeErrorCode
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeError
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeException
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeValidationException
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeGraphException
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeExtractionException
 * @see com.shreeai.os.platform.kernels.knowledge.error.KnowledgeNotFoundException
 */
