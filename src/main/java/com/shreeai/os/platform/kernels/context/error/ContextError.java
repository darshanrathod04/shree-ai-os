 ...
 * <b>ContextError</b>
 *
 * <p>An immutable value object representing a structured error in the Context Kernel.</p>
 *
 ...
 *   <li>Serves as the error model for all Context exceptions.</li>
 * </ul>
 *
 ...
 * @param metadata additional error metadata (must not be null, defensively copied)
 */
public final class ContextError {
    ...
    /**
     * Creates a new ContextError with validation and defensive copying.
     *
     ...
     *
     * <p>Two ContextError objects are equal if they have the same
    ...
    public boolean equals(Object o) {
        ...
        ContextError that = (ContextError) o;
