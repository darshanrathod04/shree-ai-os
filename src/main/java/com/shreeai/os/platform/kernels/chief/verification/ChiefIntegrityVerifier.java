...
public final class ChiefIntegrityVerifier {
    ...
    private static void verifyProcessingPipeline(List<String> violations) {
        ...
        try {
            Class.forName("com.shreeai.os.platform.kernels.chief.engine.ChiefProcessingEngine");
        } catch (ClassNotFoundException e) {
            violations.add("Missing ChiefProcessingEngine");
        }

        try {
            Class.forName("com.shreeai.os.platform.kernels.chief.engine.DefaultChiefProcessingEngine");
        } catch (ClassNotFoundException e) {
            violations.add("Missing DefaultChiefProcessingEngine");
        }

        try {
            Class.forName("com.shreeai.os.platform.kernels.chief.engine.ChiefProcessingResult");
        } catch (ClassNotFoundException e) {
