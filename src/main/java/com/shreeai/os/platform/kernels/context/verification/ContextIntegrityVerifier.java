...
public final class ContextIntegrityVerifier {
    ...
    private static List<String> verifyImmutability() {
        ...
        try {
            Class<?> contextClass = Class.forName("com.shreeai.os.platform.kernels.context.model.Context");
        ...
        try {
            Class<?> contextIdClass = Class.forName("com.shreeai.os.platform.kernels.context.model.ContextId");
        ...
        try {
            Class<?> verificationResultClass = Class.forName("com.shreeai.os.platform.kernels.context.verification.ContextVerificationResult");
        ...
        try {
            Class<?> processingResultClass = Class.forName("com.shreeai.os.platform.kernels.context.engine.ContextProcessingResult");
    ...
    private static List<String> verifyDefensiveCopying() {
        ...
        try {
            var contextClass = Class.forName("com.shreeai.os.platform.kernels.context.model.Context");
        ...
        try {
            var resultClass = Class.forName("com.shreeai.os.platform.kernels.context.validation.ContextValidationResult");
        ...
        try {
            var resultClass = Class.forName("com.shreeai.os.platform.kernels.context.verification.ContextVerificationResult");
    ...
    private static List<String> verifyConstructorValidation() {
        ...
        try {
            var contextIdClass = Class.forName("com.shreeai.os.platform.kernels.context.model.ContextId");
        ...
        try {
            var verificationResultClass = Class.forName("com.shreeai.os.platform.kernels.context.verification.ContextVerificationResult");
        ...
        try {
            var serviceClass = Class.forName("com.shreeai.os.platform.kernels.context.service.DefaultContextService");
    ...
    private static List<String> verifyThreadSafety() {
        ...
        try {
            var engineClass = Class.forName("com.shreeai.os.platform.kernels.context.engine.DefaultContextProcessingEngine");
        ...
        try {
            var validatorClass = Class.forName("com.shreeai.os.platform.kernels.context.validation.ContextValidator");
    ...
    private static List<String> verifyImmutableReturnTypes() {
        ...
        try {
            Class<?> snapshotClass = Class.forName("com.shreeai.os.platform.kernels.context.model.ContextSnapshot");
        ...
        try {
            Class<?> createRequestClass = Class.forName("com.shreeai.os.platform.kernels.context.model.CreateContextRequest");
            ...
            Class<?> updateRequestClass = Class.forName("com.shreeai.os.platform.kernels.context.model.UpdateContextRequest");
    ...
    private static List<String> verifyContextIdUsage() {
        ...
        try {
            ...
            if (returnType.equals(Class.forName("com.shreeai.os.platform.kernels.context.model.ContextId"))) {
        ...
        try {
            var contextService = Class.forName("com.shreeai.os.platform.kernels.context.api.ContextService");
            // clearContext takes ContextId parameter
            var clearMethod = contextService.getDeclaredMethod("clearContext", Class.forName("com.shreeai.os.platform.kernels.context.model.ContextId"));
        ...
        try {
            var engineClass = Class.forName("com.shreeai.os.platform.kernels.context.engine.ContextProcessingEngine");
            var clearMethod = engineClass.getDeclaredMethod("processClear", Class.forName("com.shreeai.os.platform.kernels.context.model.ContextId"));
        ...
        try {
            var snapshotClass = Class.forName("com.shreeai.os.platform.kernels.context.model.ContextSnapshot");
