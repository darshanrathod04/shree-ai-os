...
/**
 * <b>ExecutionVerificationResult</b>
 *
 * <p>Immutable value object representing the result of an execution architecture verification.
 ...
 * @since 1.0
 */
public final class ExecutionVerificationResult {
    ...
    /**
     * Constructs an {@code ExecutionVerificationResult} with the specified parameters.
     *
     * @param successful whether the verification passed
     * @param findings   the list of finding messages (must not be {@code null})
     * @param verifiedAt the verification timestamp (must not be {@code null})
     ...
     */
    public ExecutionVerificationResult(boolean successful,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExecutionVerificationResult that)) return false;
