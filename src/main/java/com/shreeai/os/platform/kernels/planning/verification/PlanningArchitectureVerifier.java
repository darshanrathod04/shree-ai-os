...
/**
 * <b>PlanningArchitectureVerifier</b>
 *
 * <p>Verifies architectural compliance of the Planning Kernel structure.
 * This verifier inspects package boundaries, dependency direction, layering,
 * and platform standards without executing any planning computation.</p>
 *
 ...
 * @since 1.0
 */
public final class PlanningArchitectureVerifier {

    private static final String PACKAGE_PREFIX = "platform.kernels.planning";
     ...
     */
    private PlanningArchitectureVerifier() {
        // Utility class — no instantiation
    }

    /**
     * Verifies the architectural compliance of the Planning Kernel.
     *
     ...
     * <p>This method inspects the Planning Kernel package structure and reports
     ...
     *
     * <p>Ensures that all Planning Kernel classes reside within the canonical
     ...
     * <ul>
     *   <li>Verifies that all classes in the Planning Kernel start with the canonical package prefix.</li>
    ...
    static void verifyPackageBoundaries(List<String> findings) {
        ...
        // (e.g., platform.kernels.planning.internal would be a violation)
     ...
     *   <li>Model layer has no dependencies on other Planning packages.</li>
     *   <li>Validation layer may depend on Model and Error.</li>
     *   <li>Error layer has no dependencies on other Planning packages.</li>
     *   <li>Service layer may depend on API, Model, Validation, and Error.</li>
    ...
    static void verifyCanonicalLayering(List<String> findings) {
        ...
        // - Service (4) can depend on: API (0), Model (1), Validation (2), Error (3)
     ...
     *
     * <p>Ensures that the Planning Kernel does not depend on forbidden
