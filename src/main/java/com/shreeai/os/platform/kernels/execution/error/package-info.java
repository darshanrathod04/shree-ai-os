 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.ExecutionErrorCode} — execution-domain error codes</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.ExecutionError} — immutable error representation</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.ExecutionException} — base exception</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.ActionExecutionException} — action failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.WorkflowExecutionException} — workflow failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.TaskExecutionException} — task failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.RecoveryException} — recovery failures</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.error.ExecutionValidationException} — validation failures</li>
 * </ul>
 *
