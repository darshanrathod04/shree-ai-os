...
/**
 * <b>GoalPlanningException</b>
 *
 * <p>Represents failures associated with goal planning operations.</p>
 *
 * <p><b>Architectural Responsibility:</b></p>
 * <ul>
 *   <li>Classifies goal planning failures.</li>
 ...
 * <ul>
 *   <li>Goal creation failures.</li>
 *   <li>Goal decomposition failures.</li>
 *   <li>Goal refinement failures.</li>
 *   <li>Goal hierarchy management failures.</li>
 * </ul>
 *
 ...
 *   <li>Does not perform goal decomposition.</li>
 ...
 * @see PlanningError
 */
public class GoalPlanningException extends PlanningException {

    /**
     * Creates a new {@code GoalPlanningException} with the specified error.
     *
     * @param error the planning error (must not be {@code null})
     * @throws IllegalArgumentException if error is {@code null}
     */
    public GoalPlanningException(PlanningError error) {
        super(error);
    }

    /**
     * Creates a new {@code GoalPlanningException} with the specified error and cause.
     *
     * @param error the planning error (must not be {@code null})
     * @param cause the original cause (may be {@code null})
     * @throws IllegalArgumentException if error is {@code null}
     */
    public GoalPlanningException(PlanningError error, Throwable cause) {
        super(error, cause);
    }
