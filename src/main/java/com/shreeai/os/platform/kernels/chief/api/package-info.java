 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.api.ChiefService} — primary façade</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.api.DecisionService} — strategic decision coordination</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.api.GoalManagementService} — goal lifecycle management</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.api.TaskDelegationService} — task delegation</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.api.KernelCoordinationService} — cross-kernel coordination</li>
 *   <li>{@link com.shreeai.os.platform.kernels.chief.api.ChiefMonitoringService} — strategic monitoring</li>
 * </ul>
 *
