 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.validation.ActionValidator} — validates action identifiers and request structure</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.validation.WorkflowValidator} — validates workflow definitions and state consistency</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.validation.TaskExecutionValidator} — validates task associations and prerequisites</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.validation.RecoveryValidator} — validates recovery strategies and configurations</li>
 *   <li>{@link com.shreeai.os.platform.kernels.execution.validation.ExecutionCriteriaValidator} — validates execution options and context</li>
 * </ul>
 *
