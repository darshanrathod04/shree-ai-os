 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutionRequest} - Immutable request model</li>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutionResult} - Immutable result model</li>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutionStatus} - Execution status enum</li>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutionType} - Execution type enum</li>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutionMetadata} - Immutable metadata model</li>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutableCapability} - Core capability interface</li>
 *   <li>{@link com.shreeai.os.platform.legacy.execution.ExecutionContext} - Immutable context helper</li>
 * </ul>
 *
