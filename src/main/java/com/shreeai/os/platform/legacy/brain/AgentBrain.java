package com.shreeai.os.platform.legacy.brain;

import com.shreeai.os.platform.legacy.brain.perception.IdentityPerceptionEngine;
import com.shreeai.os.platform.legacy.chief.ChiefOfStaffEngine;
import com.shreeai.os.platform.legacy.cognition.*;
...
import com.shreeai.os.platform.legacy.context.LessonEngine;
import com.shreeai.os.platform.legacy.context.LessonState;
import com.shreeai.os.platform.legacy.debate.swarm.DebateSwarmEngine;
import com.shreeai.os.platform.legacy.dto.AgentResponse;
import com.shreeai.os.platform.legacy.graph.KnowledgeGraphEngine;
import com.shreeai.os.platform.legacy.llm.OllamaClient;
import com.shreeai.os.platform.legacy.memory.MemoryFacade;
import com.shreeai.os.platform.project.ProjectIntelligenceEngine;
import com.shreeai.os.platform.legacy.personality.PersonalityEngine;
import com.shreeai.os.platform.legacy.router.SkillRouter;
import com.shreeai.os.platform.legacy.skills.Skill;
import com.shreeai.os.platform.legacy.learning.CourseState;
import com.shreeai.os.platform.legacy.learning.LearningSessionEngine;
import com.shreeai.os.platform.legacy.learning.TeachingEngine;
import com.shreeai.os.platform.legacy.capability.CapabilityMatch;
...
import com.shreeai.os.platform.legacy.learning.adaptive.AdaptiveLearningEngine;
import com.shreeai.os.platform.legacy.learning.adaptive.StudentLearningProfile;
import com.shreeai.os.platform.legacy.production.ConversationOptimizer;
import com.shreeai.os.platform.legacy.production.ContextResolutionEngine;
import com.shreeai.os.platform.legacy.production.FallbackEngine;
import com.shreeai.os.platform.legacy.production.ResolvedContext;
import com.shreeai.os.platform.legacy.production.ResponseRouter;
