 ...
 *   <li><b>Immutable Results</b> — {@link com.shreeai.os.platform.resolver.CapabilityResolution} is fully immutable.</li>
 *   <li><b>Thread-Safe</b> — No mutable static state, constructor injection only.</li>
 * </ul>
 *
 * <h2>Components</h2>
 * <ul>
 *   <li>{@link com.shreeai.os.platform.resolver.CapabilityResolver} — Main entry point. Resolves intent to capability.</li>
 *   <li>{@link com.shreeai.os.platform.resolver.CapabilityResolution} — Immutable resolution result with full metadata.</li>
 *   <li>{@link com.shreeai.os.platform.resolver.CapabilityScorer} — Deterministic scoring engine (40% intent, 20% priority, 20% context, 10% health, 10% availability).</li>
 *   <li>{@link com.shreeai.os.platform.resolver.ResolutionStrategy} — Extensible enum of resolution strategies.</li>
 * </ul>
 *
 ...
 *
 * @since 1.0.0
 * @see com.shreeai.os.platform.resolver.CapabilityResolver
 * @see com.shreeai.os.platform.resolver.CapabilityResolution
 * @see com.shreeai.os.platform.resolver.CapabilityScorer
 */
