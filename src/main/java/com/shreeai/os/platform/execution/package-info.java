 ...
 * <ul>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutionRequest} - Immutable request model</li>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutionResult} - Immutable result model</li>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutionStatus} - Execution status enum</li>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutionType} - Execution type enum</li>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutionMetadata} - Immutable metadata model</li>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutableCapability} - Core capability interface</li>
 *   <li>{@link com.shreeai.os.platform.execution.ExecutionContext} - Immutable context helper</li>
 * </ul>
 *
