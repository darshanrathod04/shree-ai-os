...
class ExecutionContractTest {
    ...
    void testExecutionContext_Builder_AllFields() {
        ...
        ExecutionContext context = ExecutionContext.builder()
                .decision(new com.darshan.agent.cognition.CognitiveDecision(
                        com.darshan.agent.cognition.CognitiveDecision.Action.RESPOND, "test"))
                .validationResult(new com.darshan.agent.validation.ValidationResult(
                        "val-1", "dec-1", true,
                        com.darshan.agent.validation.ValidationStatus.VALID,
                        com.darshan.agent.validation.ValidationStrategy.RULE_BASED,
                        com.darshan.agent.validation.ValidationResult.RiskLevel.LOW,
