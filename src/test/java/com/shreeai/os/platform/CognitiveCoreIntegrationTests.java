...
import com.shreeai.os.platform.legacy.autonomy.AgentGoal;
import com.shreeai.os.platform.legacy.autonomy.GoalManager;
import com.shreeai.os.platform.legacy.autonomy.SubGoal;
import com.shreeai.os.platform.legacy.brain.AgentBrain;
import com.shreeai.os.platform.legacy.brain.IntentEngine;
...
import com.shreeai.os.platform.legacy.context.ConversationSessionManager;
import com.shreeai.os.platform.legacy.memory.EpisodicMemoryEngine;
import com.shreeai.os.platform.legacy.memory.MemoryFacade;
import com.shreeai.os.platform.legacy.memory.UserProfile;
import com.shreeai.os.platform.legacy.context.ConversationManager;
import com.shreeai.os.platform.legacy.memory.episodic.Episode;
import com.shreeai.os.platform.legacy.personality.PersonalityEngine;
import com.shreeai.os.platform.legacy.service.AgentService;
...
@SpringBootTest(classes = ShreeAiOsApplication.class)
class CognitiveCoreIntegrationTests {
    ...
    @Autowired private ConversationManager lessonConversationManager;
