...
# Write files with UTF-8 without BOM
$workspaceFile = "C:\shree-ai-os\application\shree-developer-intelligence\src\test\java\com\shreeai\os\developer\workspace\WorkspaceControllerTests.java"
...
$workflowFile = "C:\shree-ai-os\application\shree-developer-intelligence\src\test\java\com\shreeai\os\developer\workflow\DeveloperWorkflowControllerTests.java"

$utf8NoBom = New-Object System.Text.UTF8Encoding($false)
[System.IO.File]::WriteAllText($workspaceFile, $workspaceTests, $utf8NoBom)
[System.IO.File]::WriteAllText($chatFile, $chatTests, $utf8NoBom)
[System.IO.File]::WriteAllText($workflowFile, $workflowTests, $utf8NoBom)
